...
PDB_ObjectFileID = "A3W2_";         // Object savefile prefix (change this in case you run multiple servers from the same folder)
PDB_VehicleFileID = "A3W2_";        // Vehicle savefile prefix (change this in case you run multiple servers from the same folder)
PDB_MessagesFileID = "A3W2_";       // Messages savefile prefix (change this in case you run multiple servers from the same folder)
PDB_AdminLogFileID = "A3W2_";       // Admin log savefile prefix (change this in case you run multiple servers from the same folder)
PDB_HackerLogFileID = "A3W2_";      // Hacker log savefile prefix (change this in case you run multiple servers from the same folder)
PDB_PlayersListFileID = "A3W2_";    // PlayerList savefile prefix (change this in case you run multiple servers from the same folder)
PDB_ServerTimeFileID = "A3W2_";     // ServerTime savefile prefix (change this in case you run multiple servers from the same folder)
